...
public class Server2 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            InterceptService.Processor<InterceptService.Iface> pro1 = new InterceptService.Processor<InterceptService.Iface>(
                    new InterceptServiceImpl());

            processor.registerProcessor("InterceptService", pro1);
